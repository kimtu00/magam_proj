...
import { MenuTemplateForm } from "@/app/seller/menu/menu-template-form";
import { MenuTemplateCard } from "@/app/seller/menu/menu-template-card";
import { getMenuTemplates } from "@/app/seller/menu/actions";
import type { MenuTemplateData } from "@/services/menu-template";
import { PageHeader } from "@/components/shared/page-header";

/**
 * 메뉴 관리 페이지 (store-admin용)
 *
 * 사장님이 자주 판매하는 메뉴를 관리합니다.
 * seller/menu와 동일한 기능을 store-admin 레이아웃에서 제공합니다.
 */
